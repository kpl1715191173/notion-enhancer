...
var RendererBackend = /** @class */ (function (_super) {
    ...
    RendererBackend.prototype._hookIPC = function (ipcRenderer, contextBridge) {
        var ipcObject = {
            ...
            sendScope: function (scope) { return ipcRenderer.send(common_1.IPC_SCOPE, JSON.stringify(scope, utils_1.walk)); },
            sendEvent: function (event) { return ipcRenderer.send(common_1.IPC_EVENT, JSON.stringify(event, utils_1.walk)); },
