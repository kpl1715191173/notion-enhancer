...
exports.MinidumpUploader = void 0;
...
var MinidumpUploader = /** @class */ (function () {
    ...
    function MinidumpUploader(dsn, _crashesDirectory, _cacheDirectory, _transport) {
        ...
        var crashpadWindows = process.platform === 'win32' && electron_version_1.supportsCrashpadOnWindows();
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.trys.push([4, 6, , 7]);
                        return [4 /*yield*/, fs_1.unlinkAsync(request.path)];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 6:
                    ...
                    case 7:
                        ...
                        if (!(response && response.status === types_1.Status.Success)) return [3 /*break*/, 9];
                    ...
                    case 10:
                        err_1 = _a.sent();
                        // TODO: Test this
                        utils_1.logger.warn('Failed to upload minidump', err_1);
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, this._filterAsync(minidumps, function (path) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var stats, e_2;
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, fs_1.statAsync(path)];
                                        case 1:
                                            stats = _a.sent();
                                        ...
                                        case 2:
                                            _a.trys.push([2, 4, , 5]);
                                            return [4 /*yield*/, fs_1.unlinkAsync(path)];
                                        case 3:
                                            _a.sent();
                                            return [3 /*break*/, 5];
                                        case 4:
    ...
    MinidumpUploader.prototype.flushQueue = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all(this._queue.get().map(function (request) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
    ...
    MinidumpUploader.prototype._scanCrashpadFolder = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dumpDirectory = path_1.join(this._crashesDirectory, this._crashpadSubDirectory);
                        return [4 /*yield*/, fs_1.readDirAsync(dumpDirectory)];
                    case 1:
                        files = _a.sent();
                        return [2 /*return*/, files.filter(function (file) { return file.endsWith('.dmp'); }).map(function (file) { return path_1.join(dumpDirectory, file); })];
                }
            });
        });
    };
    ...
    MinidumpUploader.prototype._scanBreakpadFolder = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.readDirAsync(this._crashesDirectory)];
                    case 1:
                        files = _a.sent();
                        ...
                        Promise.all(files
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        path = path_1.join(this._crashesDirectory, file);
                                        _a.label = 1;
                                    case 1:
                                        _a.trys.push([1, 3, , 4]);
                                        return [4 /*yield*/, fs_1.unlinkAsync(path)];
                        ...
                        return [2 /*return*/, files.filter(function (file) { return file.endsWith('.dmp'); }).map(function (file) { return path_1.join(_this._crashesDirectory, file); })];
                }
            });
        });
    };
    ...
    MinidumpUploader.prototype._queueMinidump = function (request) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filename = path_1.basename(request.path);
                        ...
                        if (this._queue.get().some(function (req) { return path_1.basename(req.path) === filename; })) {
                            return [2 /*return*/];
                        }
                        queuePath = path_1.join(this._cacheDirectory, filename);
                        return [4 /*yield*/, fs_1.mkdirp(this._cacheDirectory)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fs_1.renameAsync(request.path, queuePath)];
                    case 2:
                        _a.sent();
                        requests = tslib_1.__spread(this._queue.get(), [tslib_1.__assign(tslib_1.__assign({}, request), { path: queuePath })]);
                        stale = requests.splice(-MAX_REQUESTS_COUNT);
                        this._queue.set(requests);
                        return [4 /*yield*/, Promise.all(stale.map(function (req) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var e_4;
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            _a.trys.push([0, 2, , 3]);
                                            return [4 /*yield*/, fs_1.unlinkAsync(req.path)];
                                        case 1:
                                            _a.sent();
                                            return [3 /*break*/, 3];
                                        case 2:
    ...
    MinidumpUploader.prototype._toMinidumpRequest = function (transport, event, minidumpPath) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var envelopeHeaders, itemHeaders, eventPayload, bodyBuffer, minidumpContent, minidumpHeader;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!transport.isRateLimited('attachment')) return [3 /*break*/, 2];
                        return [4 /*yield*/, fs_1.readFileAsync(minidumpPath)];
                    case 1:
                        ...
                        minidumpHeader = JSON.stringify({
                            ...
                            type: 'attachment',
                            filename: path_1.basename(minidumpPath),
                        });
